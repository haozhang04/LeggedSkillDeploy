...
class ObservationBuffer:
    def __init__(self, num_envs, num_obs, include_history_steps):
        ...
        self.obs_buf = torch.zeros(self.num_envs, self.num_obs_total, dtype=torch.float32)
    ...
    def get_obs_vec(self, obs_ids):
        """iterate obs_ids in reverse order.
        obs_ids: list[int]
            0 is the latest observation, include_history_steps - 1 is the oldest.
        """
        obs = []
