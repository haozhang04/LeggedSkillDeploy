...
from .enums import MotorModeLow
from .common import float_to_hex, hex_to_float, hex_to_tau, tau_to_hex, hex_to_kp, kp_to_hex, hex_to_kd, kd_to_hex
...
class wirelessRemoteState:
    def __init__(self, head, btn_components, lx, rx, ry, ly):
        self.head = head                        # head[2]
        self.btn = btn_components               # button components
        self.lx = lx                            # left stick x axis
        self.rx = rx                            # right stick x axis
        self.ry = ry                            # right stick y axis
        self.ly = ly                            # left stick y axis
